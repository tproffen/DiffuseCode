...
!*******************************************************************************
!
SUBROUTINE diffev_load(LDATA, line, length)
!
...
!write(*,*) ' DO_LOAD DIFFEV ', ier_num, ier_typ
   IF(ier_num/= 0) RETURN
   ndata = -1                 ! Will be updated to correct value in refine_load_kuplot
ENDIF
CALL diffev_load_kuplot(LDATA, ndata)
!write(*,*) ' LOAD KUPLOT    ', ier_num, ier_typ
...
!
END SUBROUTINE diffev_load
!
!*******************************************************************************
!
SUBROUTINE diffev_load_kuplot(LDATA, ndata) !, is_data, is_sigma)
!
...
!
!
END SUBROUTINE diffev_load_kuplot
!
!*******************************************************************************
!
END MODULE diffev_load_mod
