...
!*******************************************************************************
!
subroutine lib_convert_shelx(infile, outfile)
!
...
if(initial(2)(1:56)=='# h,k,l, Fo-squared, sigma(Fo-squared), Fc and phi(calc)') then
   fcf_type = 6
   call lib_convert_shelx_fcf_6(IRD, IWR, initial)
...
elseif(initial(2)(1:47)=='# Unique observed reflections after correcting') then
   ...
   fcf_type = 2
   call lib_convert_shelx_fcf_2(IRD, IWR, initial)
   if(ier_num/=0) then
      ier_msg(1) = infile((max(1,len_trim(infile)-39)):len_trim(infile))
      close(IRD)
      close(IWR)
...
!*******************************************************************************
!
subroutine lib_convert_shelx_fcf_6(IRD, IWR, initial)
!-
...
!*******************************************************************************
!
subroutine lib_convert_shelx_fcf_4(IRD, IWR, initial)
!-
...
!*******************************************************************************
!
subroutine lib_convert_shelx_fcf_2(IRD, IWR, initial)
!-
