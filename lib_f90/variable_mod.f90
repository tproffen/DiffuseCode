...
!
   ...
   INTEGER, PARAMETER :: VAR_EXPERI    = 10
   INTEGER, PARAMETER :: VAR_KUPLOT    = 11
   INTEGER, PARAMETER :: VAR_REFINE    = 12
   INTEGER, PARAMETER :: VAR_MPI_OFF   = 13
   INTEGER, PARAMETER :: VAR_MPI_ON    = 14
   INTEGER, PARAMETER :: VAR_PROGRAM   = 15
   INTEGER, PARAMETER :: VAR_STATE     = 16
   INTEGER, PARAMETER :: VAR_MPI_FIRST = 17
   INTEGER, PARAMETER :: VAR_MPI       = 18
   INTEGER, PARAMETER :: VAR_NUM_NODES = 19
...
!
   i = VAR_EXPERI
   var_name ( i) = 'EXPERI'         ! A PROGRAM is 'SUITE', 'DISCUS', 'KUPLOT', 'DIFFEV'
   var_char ( i) = ' '
   var_l    ( i) = 6
   var_type ( i) = IS_INTE
   var_diff ( i) = .FALSE.
