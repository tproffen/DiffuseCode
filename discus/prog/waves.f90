...
!endif
!                                                                       
         IF (.not.wv_lacoust.and. (index (cr_at_lis (cr_iscat (1,i) ) ,&
            '-') .gt.0) ) then                                          
               dis = - dis 
         ENDIF 
!                                                                       
...
!                                                                       
         ELSE 
            IF (.not.wv_lacoust.and. (index (cr_at_lis (cr_iscat (1,ia) ) &
            , '-') .gt.0) ) then                                        
               dis = - dis 
            ENDIF 
!                                                                       
