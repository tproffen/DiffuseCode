...
real(kind=PREC_DP), dimension(3) :: q
!
INTEGER :: IAND, ISHFT 
...
!*******************************************************************************
!
subroutine tcsf_form_discamb(iscat, isym, ientry, fnum)
!-
...
!*******************************************************************************
!
subroutine tcsf_form_aniso(iscat, ientry, fnum)
!-
...
do h = 1, fnum(3)
   do j = 1, fnum(2)
      do i = 1, fnum(1)
         tcsf(i,j,h) = tcsf(i,j,h) * cfact(istl(i,j,h), iscat) * four_dbw(i,j,h, ientry)  ! Anisotropic ADP
      enddo
   enddo
enddo   
!
...
!*******************************************************************************
!
subroutine tcsf_form_iso(iscat, fnum)
!-
...
do h = 1, fnum(3)
   do j = 1, fnum(2)
      do i = 1, fnum(1)
         tcsf(i,j,h) = tcsf(i,j,h) * cfact(istl(i,j,h), iscat)          ! Isotropic ADP
      enddo
   enddo
enddo   
!
