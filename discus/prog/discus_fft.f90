...
REAL(KIND=PREC_DP), DIMENSION(npkt1,npkt2), INTENT(IN) :: zwrt
...
REAL(KIND=PREC_DP), DIMENSION(nnew1,nnew2), INTENT(OUT) :: znew
REAL(KIND=PREC_DP), DIMENSION(3, 4)       , INTENT(IN) :: pdf3d_eck
REAL(KIND=PREC_DP), DIMENSION(3, 3)       , INTENT(IN) :: pdf3d_vi
INTEGER           , DIMENSION(3)          , INTENT(IN) :: pdf3d_inc
!
!REAL(KIND=PREC_DP), DIMENSION(3,npkt1) :: hwrt
!REAL(KIND=PREC_DP), DIMENSION(3,npkt2) :: kwrt
!
INTEGER :: i,j, ih,ik
